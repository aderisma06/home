[home.html](https://github.com/user-attachments/files/22606651/home.html)
<!DOCTYPE html>
<html lang="id">
  <head>
    <meta charset="UTF-8" />
  ...
  <body>
    ...
    <footer>
      <div class="footer-container">
        ...
        <div class="footer-links">
          <h4>Link Terkait</h4>
          <ul>
            <li><a href="#">Website Kabupaten Ciamis</a></li>
            <li><a href="#">Portal ASN</a></li>
            <li><a href="#">Sistem Informasi Kepegawaian</a></li>
          </ul>
        </div>
    ...
    <script>
      ...
      const APPS_SCRIPT_URL =
        "https://script.google.com/macros/s/AKfycbzDVwN11FDD8seQhGdIpqMfnhTpBMJJcDHJobA1toCOvdXnlF8urADRk5oOGHFrIReM/exec";
